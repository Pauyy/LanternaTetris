...
public class TetriminoCoordinater {
    ...
    public TetriminoCoordinater(Board board, InputPoller input){
        this.board = board;
        this.rng = new PseudoRandom1History();
        this.input = input;
    }
    ...
    /**
     * Returns the identifier of the next Tetrominos generated by the RandomTetrominoGenerator
     * @param count
    ...
    public int[] getNextTetrominoIdentifier(int count){
        ...
        return queue.stream()
                .limit(length)
                .mapToInt(Tetrimino::getIdentifier)
                .toArray();
    }
